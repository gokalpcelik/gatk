...
public class EvidenceStatUtilsTest {
    ...
    public Object[][] testCalculateOneSamplePoissonTestData() {
        return new Object[][]{
                {new int[]{0}, new double[]{30.}, 0, 0.9704455335485082},
                {new int[]{0}, new double[]{30.}, 1, 0.9704455335485082},
                {new int[]{1}, new double[]{30.}, 1, 0.3570069605691474},
                {new int[]{5, 1, 0}, new double[]{30., 35., 40.}, 1, 0.01942077601750341},
        };
    }
    ...
    public void testCalculateOneSamplePoissonTest(final int[] sampleCounts,
        ...
        final double test = EvidenceStatUtils.calculateOneSamplePoissonTest(sampleCountsMap, carrierSamples,
